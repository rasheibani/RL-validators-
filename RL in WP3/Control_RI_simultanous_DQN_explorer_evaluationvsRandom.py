...
def evaluate_curriculum_models(max_seen_envs=5, max_unseen_envs=5, random_seed=42):
    ...
    for reward_type in reward_types:
        ...
        model_path = f'data/trained/curriculum/{reward_type}/best_model.zip'
...
def learn_envs(environments, max_iterations=10000):
    ...
    for reward_type in reward_types:
        ...
        model = None
        curriculum_model_dir = f'data/trained/curriculum/{reward_type}'
        ...
        for env_info in sorted_envs:
            ...
            model.learn(
                ...
                tb_log_name=f"DQN_curriculum_{reward_type}",
